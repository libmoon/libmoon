...
do
	...
	then
		...
		echo "Use ${ERROR_MSG_SUBDIR}deps/dpdk/tools/dpdk-devbind.py to bind VirtIO NICs manually"
	else
...
then
	...
	echo "You can also use the script dpdk-devbind.py in ${ERROR_MSG_SUBDIR}deps/dpdk/tools manually to manage interfaces used by Phobos and the OS."
